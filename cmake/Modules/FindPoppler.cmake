...
if( NOT WIN32 )
  ...
  pkg_check_modules(POPPLER_PKG poppler poppler-qt4)
endif( NOT WIN32 )
...
IF ("${POPPLER_PREREQS}" MATCHES "fontconfig")
  MESSAGE(WARNING "libpoppler has a dynamic dependency on Fontconfig!")
...
FIND_LIBRARY(POPPLER_QT4_LIBRARIES NAMES poppler-qt4 libpoppler-qt4
  PATHS
    /usr/lib
    /usr/local/lib
  HINTS
