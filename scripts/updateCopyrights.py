...
def manual_update_notice():
    ...
    for f in ["README.md", "res/org.tug.texworks.metainfo.xml", "res/TeXworks.in.plist", "res/texworks.1", "res/TeXworks.in.rc", "src/TWApp.cpp", ".github/actions/package-launchpad/launchpad/debian/copyright", "win32/README.win", "CMake/Modules/COPYING-CMAKE-MODULES"]:
    	print("   {0}".format(f))
